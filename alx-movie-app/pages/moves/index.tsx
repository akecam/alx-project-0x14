...
const Movies: React.FC<MProps> = () => {
  ...
  return (
    <div className="min-h-screen bg-[#110F17] text-white px-4 md:px-10 lg:pz-44">
      <div className="py-16">
        <div className="flex flex-col md:flex-row justify-between mb-4 items-center space-x-0 md:space-x-4">
          ...
          <select
            ...
            className="border-2 border-[#E2D609] outline-none bg-transparent px-4 md:px-8 mt-4 md:mt-0 rounded-full w-full md:w-auto"
          >
